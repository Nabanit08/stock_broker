...
public class CustomerUI {
	...
	public static boolean customerLogin(Scanner sc)  {
		...
		try {
			...
			if(customerDao.VerifyVendercredentials(userName, password)) {
				loginSuccess = true;
	...
	public static void customerSignUp(Scanner sc) {
		...
		CustomerDTO customerDto = new CustomerDTOImpl(0,firstName, lastName, userName, password, address, mob, email);
		CustomerDAO customerDao = new CustomerDAOImpl();
		try {
